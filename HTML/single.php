    ...
    <div class="row justify-content-center">
      <div class="col-lg-12 text-center">
        <div class="page-next-level">
          <h3 class="title text-white title-dark"> Blog </h3>
          <div class="page-next">
            <nav aria-label="breadcrumb" class="d-inline-block">
              <ul class="breadcrumb bg-white rounded shadow mb-0">
                <li class="breadcrumb-item"><a href="<?php echo home_url(); ?>">Home</a></li>
                <li class="breadcrumb-item"><a href="<?php echo home_url(); ?>/blog-events/">Blog</a></li>
      ...
      <div class="col-md-8">
        <div class="section-title">
          <div class="text-center mb-5">
            ...
            <?php the_post_thumbnail('large', array('class'=> 'img-fluid rounded-md shadow-md')); ?>
            ...
            <div class="post-navigation">
              <?php
                ...
                if (!empty( $previous_post )): ?>
                  <a href="<?php echo get_permalink( $previous_post->ID ); ?>" class="post-prev">
